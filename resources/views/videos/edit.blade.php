                    ...
                    <form action="{{ route('videos.update',$video->slug) }}" method="post" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="length" type="text" class="form-control" value="{{ $video->length }}" placeholder=" مدت زمان">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="url" id="upload_file" type="text"  value="{{ $video->url }}" class="form-control">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label>تصویر</label>
                                <input name="thumbnail" id="featured_image" type="text"  value="{{ $video->thumbnail }}" class="form-control">
                            </div>
                            <div class="col-md-6">
